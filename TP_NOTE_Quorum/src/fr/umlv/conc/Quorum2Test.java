...
public class Quorum2Test {
  @Test(timeout = 5000)
  public void simple() throws InterruptedException {
    Quorum2 quorum = new Quorum2();
  ...
  @Test(timeout = 5000)
  public void noQuorum2() throws InterruptedException {
    Quorum2 quorum = new Quorum2();
  ...
  public void noQuorum2TooManyThreads() throws InterruptedException {
    Quorum2 quorum = new Quorum2();
    Thread thread1 = new Thread(() -> {
      try {
        quorum.vote(55);
